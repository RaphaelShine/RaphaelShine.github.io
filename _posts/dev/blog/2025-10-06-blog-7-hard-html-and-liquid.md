...
## 시작하며
⠀HTML은 기본적으로는 **정적**이기 때문에 이번 포스트의 길이가 YAML처럼 엄청 짧을 수 있었지만, 개발자들은 **Liquid**이용해 HTML을 동적으로 이용하는 방법을 만들었습니다. 그렇게 여러분의 공부량이 늘어나게 되었습니다~! 저도 마찬가지....... 사실 Liquid만으로 동적 웹이라고 하기에는 어려운 게, Liquid는 동적으로 HTML을 작성해서 결국 정적인 웹이 출력되기 때문입니다.
